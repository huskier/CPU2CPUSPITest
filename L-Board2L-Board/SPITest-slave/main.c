...
int main(void)
{
	unsigned char data=255,Receive_data=2,tmp=5;
...
//       wait(2000);
       dispString("spi test read ");


       #ifdef SPI1_SLAVE_MODE
       Receive_data=spi_ch1_slavereadWrite(Receive_data%10);

   	   SPI1_SLAVE_INIT();

       dispString("spi test over ");
       dispInt(Receive_data);
       #endif
