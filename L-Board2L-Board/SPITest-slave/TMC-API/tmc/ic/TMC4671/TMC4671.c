...
void tmc4671_doEncoderInitializationMode0(u8 motor, u8 *initState, u16 initWaitTime, u16 *actualInitWaitTime, u16 startVoltage)
{
	...
	//dispString("In tmc4671_doEncoderInitializationMode0()...");


	switch (*initState)
	{
	case STATE_NOTHING_TO_DO:
		//dispString("In case STATE_NOTHING_TO_DO:...");
		*actualInitWaitTime = 0;
		break;
	case STATE_START_INIT: // started by writing 1 to initState
		dispString("In case STATE_START_INIT:...");
	...
	case STATE_WAIT_INIT_TIME:
		//dispString("In case STATE_WAIT_INIT_TIME:...");
	...
	case STATE_ESTIMATE_OFFSET:
		dispString("In case STATE_ESTIMATE_OFFSET:...");
...
{
	//dispString("In tmc4671_checkEncderInitialization()...");
...
{
	//dispString("In tmc4671_periodicJob()...");
...
{
	dispString("In tmc4671_startEncoderInitialization()...");
