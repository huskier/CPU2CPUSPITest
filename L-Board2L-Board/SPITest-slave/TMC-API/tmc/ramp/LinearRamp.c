...
void tmc_linearRamp_computeRampPosition(TMC_LinearRamp *linearRamp)
{
	if (linearRamp->rampEnabled)
	{
		...
		//dispString("TargetPosDif is : ");
		//dispInt(targetPositionsDifference);
		...
		//dispString("tempActTarPosition is : ");
		//dispInt(tempActualTargetPosition);
		...
		//dispString("rampPosition is : ");
		//dispInt(linearRamp->rampPosition);
	}
	else
	{
